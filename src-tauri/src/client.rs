...
pub fn spawn_init(tx: AppHandle, state: LiveState) {
    thread::spawn(move || {
...
pub async fn handle_stream(app_handle: AppHandle, mut stream: Stream, state: LiveState) {
                ...
                match message {
                    message::Message::Updates(mut updates) => {
                        ...
                        for update in updates.iter_mut() {
                            ...
                            match app_handle.emit_all("update event", update.clone()) {
                    ...
                    message::Message::Initial(mut initial) => {
                        ...
                        *state = initial.clone();
                        ...
                        match app_handle.emit_all("initial event", initial) {
    ...
    match env_url() {
        ...
        None => {
            ...
            headers.insert(
                ...
                http::HeaderValue::from_static("BestHttp"),
            );
            headers.insert(
